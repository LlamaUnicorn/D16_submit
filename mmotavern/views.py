...
class IndexView(LoginRequiredMixin, TemplateView):
    template_name = 'mmotavern/front.html'
...
class PostCreate(LoginRequiredMixin, CreateView):
    ...
    template_name = 'mmotavern/crud/post_create.html'

    def get_success_url(self):
        return reverse('mmotavern:post_list')
...
class PostDelete(LoginRequiredMixin, DeleteView):
    model = Post
    template_name = 'mmotavern/crud/post_delete.html'
    success_url = '/mmotavern/'
    permission_required = 'mmotavern.post_delete'
    context_object_name = 'post'
...
class CommentsList(IsAuthorMixin, View):
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'mmotavern/comments_list.html', context)
...
class CommentCreate(NotIsAuthorMixin, View):
    def get(self, request, **kwargs):
        ...
        return render(request, 'mmotavern/crud/comment_create.html', context)
    ...
    def post(self, request, *args, **kwargs):
        ...
        return redirect('mmotavern:post_list')
...
class CommentDelete(LoginRequiredMixin, DeleteView):
    model = Comment
    template_name = 'mmotavern/crud/comment_delete.html'
    success_url = '/mmotavern/'
    permission_required = 'mmotavern.comment_delete'
...
class DashboardView(View):
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'mmotavern/dashboard.html', context)
...
class CategoryView(ListView):
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'mmotavern/category_list.html', context)
...
class ByAuthorView(ListView):
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'mmotavern/by_author.html', context)
